...
from imap_processing.ultra.l2 import solid_angle_map
...
def test_build_solid_angle_map(spacing):
    ...
    solid_angle_map_steradians = solid_angle_map.build_solid_angle_map(
    ...
    solid_angle_map_sqdeg = solid_angle_map.build_solid_angle_map(
...
def test_build_solid_angle_map_invalid_spacing(spacing, match_str):
    ...
    with pytest.raises(ValueError, match=match_str):
        _ = solid_angle_map.build_solid_angle_map(
            spacing, input_degrees=True, output_degrees=False
        )
